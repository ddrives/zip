...
tape('dDatabase Core Test: Set and get', function (t) {
  var b = bitfield()
...
tape('dDatabase Core Test: Set and get (tree)', function (t) {
  var b = bitfield()
  var tree = b.tree
...
tape('dDatabase Core Test: Set and index', function (t) {
  var b = bitfield()
...
tape('dDatabase Core Test: Set and index (random)', function (t) {
  var b = bitfield()
...
tape('dDatabase Core Test: Get total positive bits', function (t) {
  var b = bitfield()
