...
tape('dDatabase Core Test: Digest', function (t) {
  var index = tree()
...
tape('dDatabase Core Test: Verified by', function (t) {
  var index = tree()
...
tape('dDatabase Core Test: Proof without a digest', function (t) {
  var index = tree()
...
tape('dDatabase Core Test: Proof with a digest', function (t) {
  var index = tree()
  t.same(index.proof(0), null)
...
tape('dDatabase Core Test: Digest sanity checks', function (t) {
  var index = tree()
  index.set(0)
...
tape('dDatabase Core Test: Chaos monkey test #1', function (t) {
  var source = tree()
  var clone = tree()
  var i = 0
...
tape('dDatabase Core Test: Chaos monkey test #2', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Test: Chaos monkey test #3', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Test: Chaos monkey test #4', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Test: Chaos monkey test #5', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Test: Chaos monkey test #6', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
...
tape('dDatabase Core Test: Chaos monkey test #7', function (t) {
  var source = tree()
  var a = tree()
  var b = tree()
