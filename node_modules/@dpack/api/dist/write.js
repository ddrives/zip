'use strict';var _slicedToArray = function () {function sliceIterator(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"]) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}return function (arr, i) {if (Array.isArray(arr)) {return arr;} else if (Symbol.iterator in Object(arr)) {return sliceIterator(arr, i);} else {throw new TypeError("Invalid attempt to destructure non-iterable instance");}};}();var recurseCopy = function () {var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(
  ...
  function _callee5(vault, sourcePath, targetPath) {var _ref6, _ref7, sourceStat, targetStat, children, i;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:_context5.next = 2;return (

              Promise.all([
              stat(vault, sourcePath),
              safeStat(vault, targetPath)]));case 2:_ref6 = _context5.sent;_ref7 = _slicedToArray(_ref6, 2);sourceStat = _ref7[0];targetStat = _ref7[1];if (!
            ...
            sourceStat.isDirectory()) {_context5.next = 16;break;}_context5.next = 16;return (
              ...
              mkdir(vault, targetPath));case 16:if (!
            ...
            new Promise(function (resolve, reject) {
              ...
              function (err) {
                if (err) reject(toDBrowserError(err, 'createReadStream/createWriteStream'));else
                resolve();
              });
            ...
            sourceStat.isDirectory()) {_context5.next = 33;break;}_context5.next = 23;return (
              ...
              readdir(vault, sourcePath));case 23:children = _context5.sent;
            ...
            if (!(typeof data === 'string' && !opts.encoding)) {_context.next = 35;break;}throw new InvalidEncodingError();case 35:if (!(typeof data !== 'string' && opts.encoding)) {_context.next = 37;break;}throw new InvalidEncodingError();case 37:return _context.abrupt('return', new Promise(function (resolve, reject) {vault.writeFile(name, data, opts, function (err) {if (err) reject(toDBrowserError(err, 'writeFile'));else resolve();});}));case 38:case 'end':return _context.stop();}}}, _callee, this, [[8, 14], [21, 27]]);})));}function mkdir(vault, name, cb) {return maybe(cb, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {var existingEntry, parentName, parentEntry;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (!(vault.key && !vault.writable)) {_context2.next = 2;break;}throw new VaultNotWritableError();case 2:if (VALID_PATH_REGEX.test(name)) {_context2.next = 4;break;}throw new InvalidPathError('Path contains invalid characters');case 4:_context2.prev = 4;_context2.next = 7;return stat(vault, name);case 7:existingEntry = _context2.sent;_context2.next = 12;break;case 10:_context2.prev = 10;_context2.t0 = _context2['catch'](4);case 12:if (!(name === '/' || existingEntry)) {_context2.next = 14;break;}throw new EntryAlreadyExistsError('Cannot overwrite files or folders');case 14: // ensure that the parent directory exists
            parentName = path.dirname(name);if (!(parentName !== '/' && parentName !== '.')) {_context2.next = 26;break;}_context2.prev = 16;_context2.next = 19;return stat(vault, parentName);case 19:parentEntry = _context2.sent;_context2.next = 24;break;case 22:_context2.prev = 22;_context2.t1 = _context2['catch'](16);case 24:if (!(!parentEntry || !parentEntry.isDirectory())) {_context2.next = 26;break;}throw new ParentFolderDoesntExistError();case 26:return _context2.abrupt('return', new Promise(function (resolve, reject) {vault.mkdir(name, function (err) {if (err) reject(toDBrowserError(err, 'mkdir'));else resolve();});}));case 27:case 'end':return _context2.stop();}}}, _callee2, this, [[4, 10], [16, 22]]);})));}function copy(vault, oldName, newName, cb) {return maybe(cb, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {var parentName, parentEntry;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:if (!(vault.key && !vault.writable)) {_context3.next = 2;break;}throw new VaultNotWritableError();case 2:if (VALID_PATH_REGEX.test(newName)) {_context3.next = 4;break;}throw new InvalidPathError('Path contains invalid characters');case 4: // ensure that the parent directory exists
            parentName = path.dirname(newName);if (!(parentName !== '/' && parentName !== '.')) {_context3.next = 16;break;}_context3.prev = 6;_context3.next = 9;return stat(vault, parentName);case 9:parentEntry = _context3.sent;_context3.next = 14;break;case 12:_context3.prev = 12;_context3.t0 = _context3['catch'](6);case 14:if (!(!parentEntry || !parentEntry.isDirectory())) {_context3.next = 16;break;}throw new ParentFolderDoesntExistError();case 16:_context3.next = 18;return recurseCopy(vault, oldName, newName);case 18:case 'end':return _context3.stop();}}}, _callee3, this, [[6, 12]]);})));}function rename(vault, oldName, newName, cb) {return maybe(cb, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {var existingEntry, st;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.prev = 0;_context4.next = 3;return stat(vault, newName);case 3:existingEntry = _context4.sent;_context4.next = 8;break;case 6:_context4.prev = 6;_context4.t0 = _context4['catch'](0);case 8:if (!(newName === '/' || existingEntry)) {_context4.next = 10;break;}throw new EntryAlreadyExistsError('Cannot overwrite files or folders');case 10:_context4.next = 12;return copy(vault, oldName, newName);case 12:_context4.next = 14;return stat(vault, oldName);case 14:st = _context4.sent;if (!st.isDirectory()) {_context4.next = 20;break;}_context4.next = 18;return rmdir(vault, oldName, { recursive: true });case 18:_context4.next = 22;break;case 20:_context4.next = 22;return unlink(vault, oldName);case 22:case 'end':return _context4.stop();}}}, _callee4, this, [[0, 6]]);})));}module.exports = { writeFile, mkdir, copy, rename // helpers
  // =
};function safeStat(vault, path) {return stat(vault, path).catch(function (_) {return undefined;});}