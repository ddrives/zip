...
require('@dbrowser/errors'),VaultNotWritableError = _require.VaultNotWritableError,SourceNotFoundError = _require.SourceNotFoundError,DestDirectoryNotEmpty = _require.DestDirectoryNotEmpty,ParentFolderDoesntExistError = _require.ParentFolderDoesntExistError;var _require2 =
...
var DEFAULT_IGNORE = ['.dpack', '**/.dpack', '.git', '**/.git'];

// copy files from the filesystem into an vault
function exportFilesystemToVault(opts, cb) {
  return maybe(cb, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {var srcPath, dstVault, dstPath, ignore, inplaceImport, dryRun, srcStat, dstStat, statThenExport, exportFile, exportDirectory, stats;return regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
            assert(opts && typeof opts === 'object', 'opts object is required');

            // core arguments, srcPath and dstVault
            srcPath = opts.srcPath;
            dstVault = opts.dstVault;
            ...
            if (!(!dstVault.writable && !dryRun)) {_context4.next = 11;break;}throw (
              new VaultNotWritableError());case 11:_context4.prev = 11;_context4.next = 14;return (
            ...
            _context4.prev = 21;_context4.next = 24;return (
              stat(dstVault, dstPath));case 24:dstStat = _context4.sent;_context4.next = 29;break;case 27:_context4.prev = 27;_context4.t1 = _context4['catch'](21);case 29:if (
            dstStat) {_context4.next = 38;break;}_context4.prev = 30;_context4.next = 33;return (
              stat(dstVault, path.dirname(dstPath)));case 33:dstStat = _context4.sent;_context4.next = 38;break;case 36:_context4.prev = 36;_context4.t2 = _context4['catch'](30);case 38:if (!(
            ...
            exportFile = function () {var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(srcPath, srcStat, dstPath) {var dstFileStats;return regeneratorRuntime.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                        ...
                        dstFileStats = null;_context2.prev = 1;_context2.next = 4;return (
                          ...
                          stat(dstVault, dstPath));case 4:dstFileStats = _context2.sent;_context2.next = 9;break;case 7:_context2.prev = 7;_context2.t0 = _context2['catch'](1);case 9:


                        // track the stats
                        stats.fileCount++;
                        stats.totalSize += srcStat.size || 0;if (!
                        dstFileStats) {_context2.next = 21;break;}if (!
                        dstFileStats.isDirectory()) {_context2.next = 18;break;}_context2.next = 15;return (

                          rmdir(dstVault, dstPath, { recursive: true }));case 15:
                        stats.addedFiles.push(dstPath);_context2.next = 19;break;case 18:

                        stats.updatedFiles.push(dstPath);case 19:_context2.next = 22;break;case 21:


                        stats.addedFiles.push(dstPath);case 22:return _context2.abrupt('return',
                        ...
                        }));case 23:case 'end':return _context2.stop();}}}, _callee2, this, [[1, 7]]);}));return function exportFile(_x3, _x4, _x5) {return _ref3.apply(this, arguments);};}();
            ...
            exportDirectory = function () {var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(srcPath, dstPath) {var dstStat, fileNames, promises;return regeneratorRuntime.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.prev = 0;_context3.next = 3;return (
                          ...
                          stat(dstVault, dstPath));case 3:dstStat = _context3.sent;_context3.next = 8;break;case 6:_context3.prev = 6;_context3.t0 = _context3['catch'](0);case 8:if (
                        dstStat) {_context3.next = 13;break;}_context3.next = 11;return (
                          mkdir(dstVault, dstPath));case 11:_context3.next = 18;break;case 13:if (!
                        dstStat.isFile()) {_context3.next = 18;break;}_context3.next = 16;return (
                          unlink(dstVault, dstPath));case 16:_context3.next = 18;return (
                          mkdir(dstVault, dstPath));case 18:_context3.next = 20;return (



                          fse.readdir(srcPath));case 20:fileNames = _context3.sent;

                        // recurse into each
                        promises = fileNames.map(function (name) {
                          return statThenExport(path.join(srcPath, name), path.join(dstPath, name));
                        });_context3.next = 24;return (
                          Promise.all(promises));case 24:case 'end':return _context3.stop();}}}, _callee3, this, [[0, 6]]);}));return function exportDirectory(_x6, _x7) {return _ref4.apply(this, arguments);};}();


            // recursively export
            stats = { addedFiles: [], updatedFiles: [], skipCount: 0, fileCount: 0, totalSize: 0 };_context4.next = 47;return (
...
function exportVaultToFilesystem(opts, cb) {
  return maybe(cb, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8() {var srcVault, dstPath, srcPath, overwriteExisting, skipUndownloadedFiles, ignore, files, statThenExport, exportFile, exportDirectory, stats;return regeneratorRuntime.wrap(function _callee8$(_context8) {while (1) {switch (_context8.prev = _context8.next) {case 0:
            assert(opts && typeof opts === 'object', 'opts object is required');

            // core arguments, dstPath and srcVault
            srcVault = opts.srcVault;
            ...
            statThenExport = function () {var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(srcPath, dstPath) {var srcStat;return regeneratorRuntime.wrap(function _callee5$(_context5) {while (1) {switch (_context5.prev = _context5.next) {case 0:if (!(
                        ...
                        ignore && match(ignore, srcPath))) {_context5.next = 2;break;}return _context5.abrupt('return');case 2:_context5.next = 4;return (
                          ...
                          stat(srcVault, srcPath));case 4:srcStat = _context5.sent;if (!
            ...
            exportDirectory = function () {var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(srcPath, dstPath) {var fileNames, promises;return regeneratorRuntime.wrap(function _callee7$(_context7) {while (1) {switch (_context7.prev = _context7.next) {case 0:_context7.next = 2;return (
                          ...
                          readdir(srcVault, srcPath));case 4:fileNames = _context7.sent;
...
function exportVaultToVault(opts, cb) {
  return maybe(cb, _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12() {var srcVault, dstVault, srcPath, dstPath, skipUndownloadedFiles, ignore, dstStat, statThenExport, exportFile, exportDirectory, stats;return regeneratorRuntime.wrap(function _callee12$(_context12) {while (1) {switch (_context12.prev = _context12.next) {case 0:
            assert(opts && typeof opts === 'object', 'opts object is required');
            ...
            // ensure we have the vault's private key
            if (dstVault.writable) {_context12.next = 11;break;}throw (
              new VaultNotWritableError());case 11:_context12.prev = 11;_context12.next = 14;return (




              stat(dstVault, dstPath));case 14:dstStat = _context12.sent;_context12.next = 19;break;case 17:_context12.prev = 17;_context12.t0 = _context12['catch'](11);case 19:if (
            dstStat) {_context12.next = 28;break;}_context12.prev = 20;_context12.next = 23;return (
              stat(dstVault, path.dirname(dstPath)));case 23:dstStat = _context12.sent;_context12.next = 28;break;case 26:_context12.prev = 26;_context12.t1 = _context12['catch'](20);case 28:if (!(
            ...
            statThenExport = function () {var _ref10 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9(srcPath, dstPath) {var srcStat;return regeneratorRuntime.wrap(function _callee9$(_context9) {while (1) {switch (_context9.prev = _context9.next) {case 0:if (!(
                        ...
                        ignore && match(ignore, srcPath))) {_context9.next = 2;break;}return _context9.abrupt('return');case 2:_context9.next = 4;return (
                          ...
                          stat(srcVault, srcPath));case 4:srcStat = _context9.sent;if (!
            ...
            exportFile = function () {var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(srcPath, srcStat, dstPath) {var dstFileStats;return regeneratorRuntime.wrap(function _callee10$(_context10) {while (1) {switch (_context10.prev = _context10.next) {case 0:if (!(
                        ...
                        dstFileStats = null;_context10.prev = 3;_context10.next = 6;return (
                          ...
                          stat(dstVault, dstPath));case 6:dstFileStats = _context10.sent;_context10.next = 11;break;case 9:_context10.prev = 9;_context10.t0 = _context10['catch'](3);case 11:
                        ...
                        dstFileStats.isDirectory()) {_context10.next = 20;break;}_context10.next = 17;return (
                          ...
                          rmdir(dstVault, dstPath, { recursive: true }));case 17:
            ...
            exportDirectory = function () {var _ref12 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(srcPath, dstPath) {var dstStat, fileNames, promises;return regeneratorRuntime.wrap(function _callee11$(_context11) {while (1) {switch (_context11.prev = _context11.next) {case 0:_context11.prev = 0;_context11.next = 3;return (
                          ...
                          stat(dstVault, dstPath));case 3:dstStat = _context11.sent;_context11.next = 8;break;case 6:_context11.prev = 6;_context11.t0 = _context11['catch'](0);case 8:if (
                        dstStat) {_context11.next = 13;break;}_context11.next = 11;return (
                          mkdir(dstVault, dstPath));case 11:_context11.next = 18;break;case 13:if (!
                        dstStat.isFile()) {_context11.next = 18;break;}_context11.next = 16;return (
                          unlink(dstVault, dstPath));case 16:_context11.next = 18;return (
                          mkdir(dstVault, dstPath));case 18:_context11.next = 20;return (



                          readdir(srcVault, srcPath));case 20:fileNames = _context11.sent;
