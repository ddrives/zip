'use strict';var findEntryByContentBlock = function () {var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(
  ...
  function _callee(vault, block) {var lo, hi, nextCursor, cursor, entry, st, origCursor, range;return regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
            vault.metadata.length <= 0)) {_context.next = 2;break;}return _context.abrupt('return');case 2:



            // do a binary search
            lo = 1;
            hi = vault.metadata.length;
            ...
            true) {_context.next = 26;break;}_context.next = 13;return (
              ...
              new Promise(function (resolve) {return (
                  vault.tree._getAndDecode(cursor, {}, function (err, entry) {
            ...
            st = vault.tree._codec.decode(entry.value);if (!(
